...
$('body').append('' +
    '<div class="fixed-button">' + '<a href="https://appseed.us/" target="_blank" class="btn btn-md btn-primary" hidden>' + '<i class="fa fa-rocket" aria-hidden="true"></i> More Starters' +
    '</a> ' + '</div>' + '');
var $window = $(window);
